...
async function up() {
  ...
  await prisma.productVariation.createMany({
    data: [
      ...
      generateProductVariation({ productId: pizza1.id, pastry: 1, size: 20 }),
      generateProductVariation({ productId: pizza1.id, pastry: 2, size: 30 }),
      generateProductVariation({ productId: pizza1.id, pastry: 2, size: 40 }),

      // Пицца "Сырная"
      generateProductVariation({ productId: pizza2.id, pastry: 1, size: 20 }),
      generateProductVariation({ productId: pizza2.id, pastry: 1, size: 30 }),
      generateProductVariation({ productId: pizza2.id, pastry: 1, size: 40 }),
      generateProductVariation({ productId: pizza2.id, pastry: 2, size: 20 }),
      generateProductVariation({ productId: pizza2.id, pastry: 2, size: 30 }),
      generateProductVariation({ productId: pizza2.id, pastry: 2, size: 40 }),

      // Пицца "Чоризо фреш"
      generateProductVariation({ productId: pizza3.id, pastry: 1, size: 20 }),
      generateProductVariation({ productId: pizza3.id, pastry: 2, size: 30 }),
      generateProductVariation({ productId: pizza3.id, pastry: 2, size: 40 }),
